...
public class LevelFailedScreen extends Group{
    ...
    public LevelFailedScreen(float w, float h) {
        ...
        title = new Image(LunarDriver.atlas.findRegion("game_over"));
        title.setX((w-title.getWidth())/2);
        title.setY(h);
        addActor(title);

        retry = new ImageButton(
                new TextureRegionDrawable(LunarDriver.atlas.findRegion("retry_btn")),
                new TextureRegionDrawable(LunarDriver.atlas.findRegion("retry_btn_down"))    );
        ...
        quit = new ImageButton(
                new TextureRegionDrawable(LunarDriver.atlas.findRegion("quit_btn")),
                new TextureRegionDrawable(LunarDriver.atlas.findRegion("quit_btn_down"))
        );
