...
import kg.lunar.driver.media.LevelIcon;
...
public class LevelList extends StageGame{
    ...
    public LevelList() {
        Image bg = new Image(LunarDriver.atlas.findRegion("intro_bg"));
        ...
        int progress = LunarDriver.data.getProgress();
        ...
        ImageButton rateBtn = new ImageButton(new TextureRegionDrawable(LunarDriver.atlas.findRegion("rate")),
                new TextureRegionDrawable(LunarDriver.atlas.findRegion("rate_down")));
        ...
        ImageButton shareBtn = new ImageButton(new TextureRegionDrawable(LunarDriver.atlas.findRegion("share")),
                new TextureRegionDrawable(LunarDriver.atlas.findRegion("share_down")));
        addChild(shareBtn);
