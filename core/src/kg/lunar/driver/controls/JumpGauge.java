...
public class JumpGauge  extends Group{
    ...
    public JumpGauge() {
        ...
        ons = new Array<Image>();
        NinePatch patch = new NinePatch(LunarDriver.atlas.findRegion("jump_gauge_off"), 3,3,3,3);
        ...
        patch = new NinePatch(LunarDriver.atlas.findRegion("jump_gauge_on"), 3, 3, 3, 3);
