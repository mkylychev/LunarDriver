package kg.lunar.driver.controls;
...
public class JoyStick extends Group {
    ...
    public JoyStick(float minHeight) {
        idle = new Image(LunarDriver.atlas.findRegion("joystick"));
        addActor(idle);
        ...
        right = new Image(LunarDriver.atlas.findRegion("joystick_right"));
        right.setSize(getWidth(), getHeight());
        addActor(right);

        left = new Image(LunarDriver.atlas.findRegion("joystick_left"));
